...
class HelpMessages:
    def __init__(self):
        ...
        self.jrrp = ".jrrp 简简单单的每日人品而已"
        self.draw = ".draw x张deck 没有则视为单张卡\n" \
                    "x:卡数 deck:牌堆\n" \
                    "输入./dhelp deck查看牌堆"
        self.deck = "现在的牌堆有:\n" + "\n".join(DeckDict.keys())
...
madness_end = [
    ...
    "10) 狂躁（Mania）：调查员患上一个新的狂躁症状。在表Ⅹ：狂躁症状表上骰1个D100来决定症状，或由守秘人选择一个。调查员会在1D10"
    "小时后恢复理智。在这次疯狂发作中，调查员将完全沉浸于其新的狂躁症状。这症状是否会表现给旁人则取决于守秘人和此调查员。 "
]
phobias = [
